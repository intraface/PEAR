...
class LiveUser_Misc_Schema_Install
{
    ...
    /**
     * Generates an array from the instance
     *
     ...
     * @access public
     */
    function generateSchemaArray($obj, $lengths = array(), $defaults = array())
    {
        if (!is_object($obj)) {
            return false;
        }
    ...
    {
        $definition = LiveUser_Misc_Schema_Install::generateSchemaArray($obj, $lengths, $defaults);
